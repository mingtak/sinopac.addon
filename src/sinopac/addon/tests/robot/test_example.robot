...
#
#  $ bin/test -s sinopac.addon -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src sinopac.addon.testing.SINOPAC_ADDON_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/sinopac/addon/tests/robot/test_example.robot
#
